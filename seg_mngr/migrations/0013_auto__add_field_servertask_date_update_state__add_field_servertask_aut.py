...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'seg_mngr_servertask', 'date_update_state',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 12, 0, 0)),
                      keep_default=False)

        # Adding field 'ServerTask.autor_update_state'
        db.add_column(u'seg_mngr_servertask', 'autor_update_state',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServerTask.date_update_state'
        db.delete_column(u'seg_mngr_servertask', 'date_update_state')

        # Deleting field 'ServerTask.autor_update_state'
        db.delete_column(u'seg_mngr_servertask', 'autor_update_state_id')
