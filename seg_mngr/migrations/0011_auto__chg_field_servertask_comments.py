...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServerTask.comments'
        db.alter_column(u'seg_mngr_servertask', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'ServerTask.comments'
        db.alter_column(u'seg_mngr_servertask', 'comments', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
