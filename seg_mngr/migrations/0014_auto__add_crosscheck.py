...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CrossCheck'
        db.create_table(u'seg_mngr_crosscheck', (
        ...
        db.send_create_signal(u'seg_mngr', ['CrossCheck'])


    def backwards(self, orm):
        # Deleting model 'CrossCheck'
        db.delete_table(u'seg_mngr_crosscheck')
