...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.task_group'
        db.add_column(u'seg_mngr_task', 'task_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['seg_mngr.TaskGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.task_group'
        db.delete_column(u'seg_mngr_task', 'task_group_id')
