...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'seg_mngr_periodictask', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('frecuency', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'seg_mngr', ['PeriodicTask'])

        # Adding M2M table for field server on 'PeriodicTask'
        m2m_table_name = db.shorten_name(u'seg_mngr_periodictask_server')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('periodictask', models.ForeignKey(orm[u'seg_mngr.periodictask'], null=False)),
            ('server', models.ForeignKey(orm[u'seg_mngr.server'], null=False))
        ))
        db.create_unique(m2m_table_name, ['periodictask_id', 'server_id'])


        # Changing field 'CrossCheck.check_date'
        db.alter_column(u'seg_mngr_crosscheck', 'check_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'PeriodicTask'
        db.delete_table(u'seg_mngr_periodictask')

        # Removing M2M table for field server on 'PeriodicTask'
        db.delete_table(db.shorten_name(u'seg_mngr_periodictask_server'))


        # Changing field 'CrossCheck.check_date'
        db.alter_column(u'seg_mngr_crosscheck', 'check_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'seg_mngr.periodictask': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'server': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['seg_mngr.Server']", 'symmetrical': 'False'})
        },
        u'seg_mngr.server': {
