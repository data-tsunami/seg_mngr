...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.nivel_exposicion'
        db.add_column(u'seg_mngr_server', 'nivel_exposicion',
                      self.gf('django.db.models.fields.IntegerField')(default=3, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.nivel_exposicion'
        db.delete_column(u'seg_mngr_server', 'nivel_exposicion')
