...
from seg_mngr.models import Server, Task, ServerTask, OperatingSystem, \
    Location, TaskGroup
...
#         location_2 = Location.objects.get(pk=2)
        ...
        server_1 = Server.objects.create(name='Dhcp',
                                         operating_system=operating_system_1,
                                         location=location_2,
                                         nivel_exposicion=1)
        server_2 = Server.objects.create(name='DNS',
                                         operating_system=operating_system_1,
                                         location=location_1,
                                         nivel_exposicion=2)
        server_3 = Server.objects.create(name='Maestro',
                                         operating_system=operating_system_2,
                                         location=location_2,
                                         nivel_exposicion=3)
...
#         task_group_2 = TaskGroup.objects.get(pk=2)
        ...
        task_1 = Task.objects.create(name='modificar user admin',
                                     description='modifcar user',
                                     task_group=task_group_1)
        task_2 = Task.objects.create(name='configurar ftp',
                                     description='configurar',
                                     task_group=task_group_2)
        task_3 = Task.objects.create(name='modificar permisos del grupo user',
                                     description='modificar permisos a grupo',
                                     task_group=task_group_1)
